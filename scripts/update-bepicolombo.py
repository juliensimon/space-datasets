...
COLUMN_DESCRIPTIONS = {
    ...
    "measurement_type": "Type of physical measurement performed (e.g. phot.flux for photon flux, phys.flux for physical flux)",
    "processing_level": "PDS/PSA data processing level: 1 = raw telemetry, 2 = calibrated data in physical units, 3 = derived/higher-order products",
    ...
    "spectral_range_min": "Minimum wavelength or frequency of the spectral coverage; units vary by instrument (nm for UV/optical, um for IR, keV for X-ray); null for non-spectral instruments",
    "spectral_range_max": "Maximum wavelength or frequency of the spectral coverage",
