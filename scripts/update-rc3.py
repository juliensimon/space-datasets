...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        banner_file = download_banner("rc3", tmp)
        banner_md = banner_markdown("rc3", banner_file)
...
If you find this dataset useful, please give it a ❤️ on the [dataset page](https://huggingface.co/datasets/juliensimon/rc3-galaxy-morphology) and share feedback in the Community tab! Also consider giving a ⭐️ to the [space-datasets](https://github.com/juliensimon/space-datasets) repo.
