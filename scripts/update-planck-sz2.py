...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        col_descriptions = {
            ...
            "dec": "ICRS J2000.0 declination of the SZ centroid in degrees (-90–+90)",
            "lii": "Galactic longitude of the SZ centroid in degrees (0–360)",
            "bii": "Galactic latitude of the SZ centroid in degrees (-90–+90)",
            ...
            "msz": "SZ-derived cluster mass M_500 in units of 10^14 solar masses (multiply by 1e14 for M_sun); Planck clusters range ~1–15 × 10^14 M_sun; null if Y_5R500 is poorly constrained",
            ...
            "pipeline_det": "Detection pipeline confirmation flags; encodes which of MMF1 (matched multi-frequency filter 1), MMF3 (matched multi-frequency filter 3), and PwS (PowellSnakes Bayesian algorithm) detected the cluster",
