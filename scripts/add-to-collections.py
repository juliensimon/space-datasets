...
DATASETS = {
    ...
    SMALL_BODIES: [
        "juliensimon/asterank-asteroid-mining",
        "juliensimon/gaia-dr3-solar-system-objects",
        "juliensimon/asteroid-lightcurves-lcdb",
        "juliensimon/bus-demeo-asteroid-taxonomy",
        "juliensimon/comet-catalog",
        "juliensimon/fireball-bolide-events",
    ...
    ASTRONOMY: [
        ...
        "juliensimon/gaia-dr3-binary-masses",
        ...
        "juliensimon/gaia-dr3-rotation-modulation",
        ...
        "juliensimon/iras-faint-source-catalog",
