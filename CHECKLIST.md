...
Reusable checklist for adding any new dataset to `juliensimon/space-datasets`. Learned from building 159 datasets. For architecture, workflow template, and source gotchas, see `CLAUDE.md`.
