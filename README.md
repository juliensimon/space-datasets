...
<!-- TOP_DOWNLOADS_START -->
**355,572** downloads (all-time) (+3,746)  ·  **29** likes  ·  **232** datasets  ·  updated 2026-09-21

| # | Dataset | Downloads |
|--:|---------|----------:|
| 1 | [wmo-oscar-satellites](https://huggingface.co/datasets/juliensimon/wmo-oscar-satellites) | 33,523 (+675) |
| 2 | [esa-rosetta-observations](https://huggingface.co/datasets/juliensimon/esa-rosetta-observations) | 20,650 (+3) |
| 3 | [esa-exomars-tgo-observations](https://huggingface.co/datasets/juliensimon/esa-exomars-tgo-observations) | 20,432 (+16) |
| 4 | [space-track-tle-history](https://huggingface.co/datasets/juliensimon/space-track-tle-history) | 13,650 (+423) |
| 5 | [gaia-dr3-eclipsing-binaries](https://huggingface.co/datasets/juliensimon/gaia-dr3-eclipsing-binaries) | 11,445 (+3) |
| 6 | [gaia-dr3-white-dwarfs](https://huggingface.co/datasets/juliensimon/gaia-dr3-white-dwarfs) | 11,327 (+6) |
| 7 | [gaia-dr3-rrlyrae](https://huggingface.co/datasets/juliensimon/gaia-dr3-rrlyrae) | 10,279 (+4) |
| 8 | [gaia-dr3-cepheids](https://huggingface.co/datasets/juliensimon/gaia-dr3-cepheids) | 10,240 (+3) |
| 9 | [gaia-dr3-young-stellar-objects](https://huggingface.co/datasets/juliensimon/gaia-dr3-young-stellar-objects) | 9,879 (+2) |
| 10 | [gaia-dr3-spectroscopic-binaries](https://huggingface.co/datasets/juliensimon/gaia-dr3-spectroscopic-binaries) | 9,647 (+3) |
<!-- TOP_DOWNLOADS_END -->
...
| [yarkovsky-nea-drifts](https://huggingface.co/datasets/juliensimon/yarkovsky-nea-drifts) | 247 Near-Earth Asteroids with direct Yarkovsky semimajor-axis drift measurements (Greenberg+ 2020) | — | Static | <1 MB |
...
| [parker-solar-probe-encounters](https://huggingface.co/datasets/juliensimon/parker-solar-probe-encounters) | 24 PSP perihelion encounters + 7 Venus gravity assists across 7 mission phases | — | Static | <1 MB |
...
| [solar-orbiter-encounters](https://huggingface.co/datasets/juliensimon/solar-orbiter-encounters) | 13 Solar Orbiter perihelia + 5 Venus + 1 Earth gravity assists, ramping to 17°+ heliographic latitude | — | Static | <1 MB |
...
| [galactic-novae-schaefer](https://huggingface.co/datasets/juliensimon/galactic-novae-schaefer) | 402 Galactic classical novae with peak V magnitudes, reddening, and distance moduli (Schaefer 2022) | — | Static | <1 MB |
...
| [gw-candidate-alerts](https://huggingface.co/datasets/juliensimon/gw-candidate-alerts) | 5.5K low-latency gravitational-wave candidate alerts from GraceDB across O3 and O4, including unconfirmed ones | ![GW alerts](https://img.shields.io/badge/dynamic/json?url=https://raw.githubusercontent.com/juliensimon/space-datasets/main/status.json&query=$['gw-candidate-alerts']&label=updated&color=brightgreen) | Weekly | 0.5 MB |
...
| [hot-subdwarf-stars](https://huggingface.co/datasets/juliensimon/hot-subdwarf-stars) | 1,714 spectroscopically identified hot subdwarf (sdB/sdO) stars from Kilkenny+ III/137 | — | Static | <1 MB |
...
| [hypervelocity-stars-li2023](https://huggingface.co/datasets/juliensimon/hypervelocity-stars-li2023) | 52 hypervelocity star candidates with 6D phase-space and 5 Galactic-potential unbound probabilities (Li+ 2023) | — | Static | <1 MB |
...
| [maxi-xray-sources](https://huggingface.co/datasets/juliensimon/maxi-xray-sources) | 170 persistent X-ray sources from the JAXA MAXI all-sky monitor on the ISS (2009+) | — | Static | <1 MB |
...
| [nicer-observations](https://huggingface.co/datasets/juliensimon/nicer-observations) | 63K NICER X-ray timing observations from the ISS instrument — every pointing since 2018 | — | Static | 4.4 MB |
...
| [symbiotic-stars-catalog](https://huggingface.co/datasets/juliensimon/symbiotic-stars-catalog) | 218 confirmed + suspected symbiotic stars — interacting WD + red-giant binaries (Belczynski 2000) | — | Static | <1 MB |
...
| [veron-agn-quasar-catalog](https://huggingface.co/datasets/juliensimon/veron-agn-quasar-catalog) | 169K quasars and AGN from Veron-Cetty & Veron 13th edition — canonical reference compilation | — | Static | 3.8 MB |
