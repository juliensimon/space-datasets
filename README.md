...
<!-- TOP_DOWNLOADS_START -->
**227,443** downloads (all-time) (+1,036)  ·  **19** likes  ·  **230** datasets  ·  updated 2026-06-24

| # | Dataset | Downloads |
|--:|---------|----------:|
| 1 | [esa-rosetta-observations](https://huggingface.co/datasets/juliensimon/esa-rosetta-observations) | 20,149 (+1) |
| 2 | [esa-exomars-tgo-observations](https://huggingface.co/datasets/juliensimon/esa-exomars-tgo-observations) | 18,480 (+9) |
...
| 6 | [gaia-dr3-rrlyrae](https://huggingface.co/datasets/juliensimon/gaia-dr3-rrlyrae) | 10,085 (+1) |
| 7 | [gaia-dr3-young-stellar-objects](https://huggingface.co/datasets/juliensimon/gaia-dr3-young-stellar-objects) | 9,771 |
| 8 | [gaia-dr3-spectroscopic-binaries](https://huggingface.co/datasets/juliensimon/gaia-dr3-spectroscopic-binaries) | 9,502 |
| 9 | [space-track-tle-history](https://huggingface.co/datasets/juliensimon/space-track-tle-history) | 7,060 (+11) |
| 10 | [wmo-oscar-satellites](https://huggingface.co/datasets/juliensimon/wmo-oscar-satellites) | 6,783 (+4) |
<!-- TOP_DOWNLOADS_END -->
